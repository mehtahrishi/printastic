...
const productSchema = z.object({
    ...
    gsm180Price: z.coerce.number().optional(),
    gsm240Price: z.coerce.number().optional(),
...
export async function createProduct(prevState: any, formData: FormData) {
    ...
    const validatedFields = productSchema.safeParse({
        ...
        gsm180Price: formData.get("gsm180Price") ? formData.get("gsm180Price") : undefined,
        gsm240Price: formData.get("gsm240Price") ? formData.get("gsm240Price") : undefined,
    ...
    const insertData = {
        ...
        gsm180Price: validatedFields.data.gsm180Price?.toString(),
        gsm240Price: validatedFields.data.gsm240Price?.toString(),
