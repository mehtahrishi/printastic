                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground mt-1">
                                If there is a quality issue with the t-shirt or the print, we will offer a replacement. In case of a quality issue with the product, such as defects in the t-shirt or print, we will provide a replacement. The replacement will be processed within 5-7 business days. To be eligible, please contact us at <a href="mailto:support@honestyprinthouse.in" className="text-primary underline">support@honestyprinthouse.in</a> with photos of the issue and your order number.
                            </p>
                        </div>
                    </div>
