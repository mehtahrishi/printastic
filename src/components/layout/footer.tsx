...
const MastercardIcon = (props: SVGProps<SVGSVGElement>) => (
    <svg className="fill-black dark:fill-white" width="38" height="24" viewBox="0 -6 36 36" xmlns="http://www.w3.org/2000/svg" {...props}>
...
const PayPalIcon = (props: SVGProps<SVGSVGElement>) => (
    <svg className="fill-black dark:fill-white" width="38" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" {...props}>
...
export function Footer() {
    ...
    const [hasBlinking, setHasBlinking] = useState(false);
    ...
    useEffect(() => {
        const handleScroll = () => {
            ...
            // Check if brand name is in viewport
    ...
    return (
        <footer className="bg-muted text-muted-foreground pt-12">
            <div className="container">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-2 md:col-span-1">
                        <Link href="/" className="flex items-center gap-2 mb-4">
                            ...
                            <span className="font-bold text-xl text-foreground">Printastic</span>
                        </Link>
                        <p className="text-sm max-w-xs mb-4">Unique, high-quality prints from independent artists.</p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li><Link href="#" className="hover:text-primary text-sm">New Arrivals</Link></li>
                            <li><Link href="#" className="hover:text-primary text-sm">All Products</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li><Link href="/terms-and-conditions" className="hover:text-primary text-sm">Terms & Conditions</Link></li>
                            <li><Link href="/privacy-policy" className="hover:text-primary text-sm">Privacy Policy</Link></li>
                            <li><Link href="/shipping-policy" className="hover:text-primary text-sm">Shipping Policy</Link></li>
                            <li><Link href="/refund-policy" className="hover:text-primary text-sm">Refund Policy</Link></li>
                        </ul>
                    </div>

                </div>

                <div className="mt-8 py-6 border-t border-border/50 flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
                    <p className="text-sm text-center">&copy; {new Date().getFullYear()} Printastic. All rights reserved.</p>
                ...
                <div ref={brandRef} className="py-12 overflow-hidden max-h-32 md:max-h-48">
                    <h2 
                        className={`font-bold text-center text-[clamp(4rem,15vw,12rem)] text-foreground/30 dark:text-muted-foreground/40 leading-none transition-opacity duration-300 ${
                            isVisible ? 'opacity-100' : 'opacity-0'
                        } ${hasBlinking ? 'animate-blink-twice' : ''}`}
                        onAnimationEnd={() => setHasBlinking(false)}
                    >
                        Printastic
                    </h2>
                </div>
